...
//                        echo $_FILES['file']['name']; die;
            ...
            //$no_pasporku = $this->input->post('negara');
            //echo "gk kebaca no paspor nya wkwk"; die;
            //echo hashids_decrypt($zona_id); die;
            //echo $no_pasporku; die;
            ...
            $no_paspor = $this->input->post('no_paspor_hidden');
...
//            $tanggal_convert = date('Y-m-d', strtotime($tanggal));
            ...
            if($this->session->userdata('id_user')!="1"){
               // echo "yg login bukan superadmin"; die;
                $no_paspor = $old_no_paspor;
            } else {
                //echo "yg login superadmin"; die;
                $no_paspor = preg_replace('/ /', '', $this->input->post('no_paspor_hidden'))  ;
               // echo $no_paspor; die;
