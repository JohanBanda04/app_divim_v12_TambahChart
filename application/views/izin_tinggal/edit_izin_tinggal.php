        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="bd p-15">
                    ...
                    ?>
                    <h5 class="m-0">subah Data Izin Tinggal <span style="color: #490411"><?php echo $nama_zona['nama_panjang']; ?></span></h5>
                </div>
                    ...
                    <form id="form_edit-<?php echo $row['id'];?>" method="POST" action="izintinggal/data_itk/<?php echo hashids_encrypt($row['id_zona']) ?>/e"
                        ...
                        <div class="form-group">
                            ...
                            <?php if ($_SESSION['level']!='superadmin'){
                                ...
                                <input class="form-control border-grey" type="" disabled required value="<?php
                                echo $row['no_paspor'];
                                ?>" name="no_paspor_hidden" />
                                <?php
                            } else { ?>
                                <input class="form-control border-grey" type="" value="<?php
                                echo $row['no_paspor'];
                                ?>" name="no_paspor_hidden" />
