...
<head>
  ...
  <title>SIDE WARAS - SISTEM DATABASE WARGA ASING</title>
  <style>
    #loader {
  ...
  <!--end of calendar-15 header-->
    ...
    <link rel="shortcut icon" href="img/side_waras_title.png" type="image/x-icon" />
                ...
                <div class="peers ai-c fxw-nw">
                  <div class="peer">
                    <div class="logo" style="padding: 10px 5px 0px 5px;">
                        <br>
                      <img style="width: 95px; height: 65px; margin-left: -15px; margin-top: -11px; "
                           src="assets/agenda/assets/static/images/side_waras_title.png" alt="" />
                    </div>
                  </div>
                  <div class="peer peer-greed">
                    <h5 class="lh-1 mB-0 logo-text" style="padding-left: 20px">SIDE WARAS</h5>
                    <h7 class="lh-1 mB-0 logo-text" style="padding-left: 20px">Sistem Database</h7>
                    <h7 class="lh-1 mB-0 logo-text" style="padding-left: 20px; margin-left: 11px;">Warga Asing</h7>
                  </div>
                </div>
              </a>
            </div>
            ...
            <?php if($_SESSION['token_katamaran']){ ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <span class="icon-holder"><i class="c-red-500 ti-write"></i>
                        ...
                        <span class="title">Data Izin Tinggals</span>
                    ...
                    <ul class="dropdown-menu" style="display: none;">
                        ...
                        <?php foreach ($zona as $index => $data){
                            ?>
                            <li <?php if($data['nama_zona']=="kasub_inteldakim" || $data['nama_zona']=="superadmin" || $data['nama_zona']=="divim_kanwil"){
                                ?> hidden <?php
            ...
            if ($level == 'superadmin') : ?>
              <li class="nav-item">
                <a class="sidebar-link" href="<?php if ($level == 'superadmin') {
                                                ...
                                                echo "profile.html";
                                              } ?>"><span class="icon-holder"><i class="c-deep-purple-500 ti-user"></i> </span><span class="title">sData Pengguna</span></a>
              </li>
          <?php endif;
          endif; ?>
          <?php if (isset($ceks)) : ?>
